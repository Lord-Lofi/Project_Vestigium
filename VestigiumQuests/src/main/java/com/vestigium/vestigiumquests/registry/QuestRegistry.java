...
public class QuestRegistry {
    ...
    private void saveDefaults(File dir) {
        List<DefaultQuest> defaults = List.of(
            ...
            // ---- PIGLINS ----
            new DefaultQuest("piglin_golden_offering", "The First Offering", "piglins",
                "COLLECT", "GOLD_INGOT", 8,
                "Gather eight gold ingots as tribute. The Piglins track what you carry.",
                0, 9999, "", false, 60, 0, "", List.of(), ""),
            new DefaultQuest("piglin_brute_trial", "Trial by Fire", "piglins",
                "KILL", "PIGLIN_BRUTE", 5,
                "The Overlord watches how you fight. Defeat five Piglin Brutes in the bastion. You are being evaluated.",
                0, 9999, "", false, 80, 5, "piglin_expedition_log_main", List.of(), "piglin_golden_offering"),
            new DefaultQuest("piglin_relic_recovery", "Reclaim the Blades", "piglins",
                "COLLECT", "GOLDEN_SWORD", 3,
                "Recover three golden blades from collapsed expedition caches. The Piglins cannot carry them without risk. You can.",
                0, 9999, "", false, 100, 5, "piglin_golden_directive_main", List.of(), "piglin_brute_trial"),
            new DefaultQuest("piglin_historian_vigil", "The Weight of Gold", "piglins",
                "SURVIVE", "omen_300", 1,
                "The Overlord asks that you endure a high-omen night in the Nether. It says nothing further. Stand your ground.",
                200, 9999, "", false, 200, -10, "", List.of(), "piglin_relic_recovery"),
            new DefaultQuest("piglin_expedition_search", "The Expedition Site", "piglins",
                "EXPLORE", "piglin_expedition_camp", 1,
                "An Antecedent expedition camp lies somewhere in the Nether. Locate it. The Piglins say something was left there that is not theirs to touch.",
                0, 9999, "", false, 100, 5, "", List.of(), "piglin_golden_offering"),
            new DefaultQuest("piglin_gold_tithe_daily", "Daily Tribute", "piglins",
                "COLLECT", "GOLD_INGOT", 4,
                "Bring four gold ingots as daily tribute. The Piglins always want more.",
                0, 9999, "", true, 25, 0, "", List.of(), ""),
            ...
            new DefaultQuest("conclave_paper_supply", "Paper for the Archive", "conclave",
                ...
                0, 9999, "", false, 60, 0, "", List.of(), ""),
            new DefaultQuest("conclave_piglin_record", "Voices from the Gold", "conclave",
                "LORE", "piglin_", 2,
                "Collect two fragments from the Piglin lore chain. The Conclave believes the Piglins remember something the Antecedents tried to bury.",
                0, 9999, "", false, 120, -10, "", List.of(), "piglin_relic_recovery"),
